...
\begin{enumerate}
    ...
    \item Mean discordance is 0.874 bands, so the typical violation is a one-band miss.
\end{enumerate}
...
Coherent Buys earn $+2.94$ pp higher 6-month realised return than discordant ones, conditional on volatility, segment, and year. The positive sign with $p < 10^{-12}$ observationally falsifies the prior that regulatory coherence imposes a return tax. The raw slice gap is $+3.31$ pp, so controls absorb only $\sim$0.4 pp ($\sim$11\% of the unconditional gap). This implies that coherence is not a volatility, segment, or year confound. However, it is important to note that unobserved confounders (financial literacy, advisor channel, account constraints) are not ruled out.
