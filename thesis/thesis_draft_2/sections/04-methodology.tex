...
\node[evalbanner, anchor=north] (eval) at ([yshift=-7.3cm]ch.south) {\textbf{Evaluate on three axes:} Return (ROI), Accuracy (nDCG), Risk Suitability (PC).\quad \textbf{Balance} $=$ harmonic mean of the three, the evaluation criterion behind our title.};
